...
// AgentsAccessPermissions returns the org-level permissions for
// the agents-access system role. It grants chat create/read/update
// to org members who have the role assigned.
// ActionDelete is intentionally excluded: no dbauthz function
// checks it on ResourceChat. Hard-deletion goes through
// ResourceSystem (dbpurge).
func AgentsAccessPermissions(_ OrgSettings) OrgRolePermissions {
